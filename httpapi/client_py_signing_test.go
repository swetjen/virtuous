...
func TestHTTPAPIPythonClientSigningEnvelopeIsEmitted(t *testing.T) {
	signing := testHTTPAPIPythonSigning(t)
...
func TestHTTPAPISignedPythonClientLoadsThroughVerifiedLoader(t *testing.T) {
	signing, rootPublicKey := testHTTPAPIPythonSigningWithRoot(t)
	router := NewRouter(WithPythonClientSigning(signing))
...
func testHTTPAPIPythonSigning(t *testing.T) PythonClientSigning {
	t.Helper()
	signing, _ := testHTTPAPIPythonSigningWithRoot(t)
	return signing
}

func testHTTPAPIPythonSigningWithRoot(t *testing.T) (PythonClientSigning, ed25519.PublicKey) {
	t.Helper()
